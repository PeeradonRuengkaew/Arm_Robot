...
class move(object):
    ...
    def __init__(self):
        ...
        gripper_group = moveit_commander.MoveGroupCommander("braccio_hand")
    ...
    def go_home(self):
        ...
        joint_goal[1] = 45 * (pi/180)
        joint_goal[2] = 180 * (pi/180)
    ...
    def gripper_close(self):
     self.go_gripper(1.26)

    def gripper_open(self):
     self.go_gripper(0.18)
...
def main():
    try:
        ...
        input("============ Press `Enter` to execute a open hand ...")
        tutorial.gripper_open()

        input("============ Press `Enter` to execute a close hand ...")
